    ...
    function putInArticle(data) {
        ...
        //'<img src="/img/weixin.jpg">' '<p class="show-weixin-pic">欢迎加微信交流：hemingrui123</p>' +'</div></article-top><div class="article-i-say">' +
        //'但愿人长久，千里共婵娟<span class="article-i-say-me">--- 何明锐</span>' +
        //'</div>'
       ...
       /* $('.other').append($('<div class="social-share" data-initialized="true" data-url="#' + data.articleId  + '"  data-title="' + data.articleTitle + '">' +
            '<a href="#" class="social-share-icon icon-qq" data-am-popover="{content: \'分享至QQ\', trigger: \'hover focus\'}"></a>' +
