...
public class UserServiceImpl implements UserService {
    ...
    public String insert(User user) {
        ...
        if("male".equals(user.getGender())){     
            user.setAvatarImgUrl("https://hmr-myblog.oss-cn-beijing.aliyuncs.com/public/registerheader.jpg");
        } else {
            user.setAvatarImgUrl("https://hmr-myblog.oss-cn-beijing.aliyuncs.com/public/female.jpg");
        }
