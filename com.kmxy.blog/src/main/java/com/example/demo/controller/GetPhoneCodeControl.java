...
import com.example.demo.component.PhoneRandomBuilder;
...
//        在redis中保存手机号验证码并设置过期时间
        ...
        String msgCode = "SMS_171675174";
        //注册的短信模板
        if(REGISTER.equals(sign)){
            msgCode = "SMS_171675174";
        }
        //改密码的短信模板
        else {
            msgCode = "SMS_171675174";
    ...
    public static SendSmsResponse sendSmsResponse(String phoneNumber, String code, String SMS_171675174) throws ClientException {

        //可自助调整超时时间
        System.setProperty("sun.net.client.defaultConnectTimeout", "10000");
        System.setProperty("sun.net.client.defaultReadTimeout", "10000");
        //"***"分别填写自己的AccessKey ID和Secret
        IClientProfile profile = DefaultProfile.getProfile("cn-hangzhou", "LTAIYJ3RaJm5Vf6i", "bgFEJrvbkqhGBPsHA8JiwCLo15AloI");
        ...
        //此处填写已申请的短信签名
        request.setSignName("博客验证码");
        //此处填写获得的短信模版CODE
        request.setTemplateCode(SMS_171675174);
